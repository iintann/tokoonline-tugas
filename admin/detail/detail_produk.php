...
<div class="card shadow bg-white">
	...
	<div class="card-body">
		...
		<div class="form-group row">
			...
			<div class="col-sm-9">
				<input disabled class="form-control" value="<?php echo $detail_produk['berat_produk']; ?>">
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-9">
				<textarea disabled class="form-control" value="<?php echo $detail_produk['deskripsi_produk']; ?>"></textarea>
			</div>
		</div>
